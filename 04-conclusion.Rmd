...
The advantage from data granularity is large: half of the 11,166,336 census blocks in 2010 were smaller than a tenth of a square mile---Charlottesville itself contains XXX census blocks.
...
Lastly, data from the 2010 US Religion Census: Religious Congregations and Membership Study is collected only at the county-level.
Since tract geography follows county geography, I simply joined those county figures to each tract, taking the county average as the tract-level average.
