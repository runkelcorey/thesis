...
Between 2007 and 2012, 10 million Americans---1 of every 20 adults---lost their homes.\footnote{Martin and Niedt, \emph{Foreclosed America}.}
It was clear then that homeowners needed an intervention.
When Countrywide, which two years earlier had serviced 20\% of the mortgages in the United States,\footnote{Seabrooke, \emph{The Politics of Housing Booms and Busts}.} collapsed in July 2008, it was clear that the real estate industry needed to change.
...
These facts suggest that neighborhoods with prime borrowers contracted the foreclosure contagion from subprime borrowers, which seems, 12 years later, to be proximately true.\footnote{Tooze, \emph{Crashed}; Mian, Sufi, and Trebbi, ``The Political Economy of the US Mortgage Default Crisis.''}
...
An ill-informed question about the effects of the national debt on the candidates' lives is cited by campaign advisers and political analysts as an inflection point in the race when Clinton could connect and Bush could not.\footnote{``Clinton.''}
...
{\centering \includegraphics[width=0.3\linewidth]{figure/publicdebt} 
...
\epigraph{Keynes took it for granted that current consumption expenditure is a highly dependable and stable function of current income.}{A Theory of the Consumption Function \\ Milton Friedman}
...
This claim is supported in no small part by the fact that homeowners are represented worldwide by conservative political parties.\footnote{Ansell, ``The Political Economy of Ownership,'' May 2014, 387.}
...
I split hairs over this behavior with Ansell (2014), who maintains it is self-identifying liberals who maintain an ideological opposition to spending cuts.\footnote{Ansell, ``The Political Economy of Ownership,'' May 2014, 387.}
...
Rather, its small effects and lack of advertising\footnote{Gass, ``Guide to Marketing and Selling NSP Homes,'' 5.} (and reciprocal press coverage) simplify an analysis that would otherwise seek to account for the media narrative surrounding such a program.
...
Republican voting by evangelical Protestants and members of the Church of Latter-Day Saints (LDS, or the Mormon Church) is much more predictable than voting by members adherent to any religion,\footnote{``A Deep Dive into Party Affiliation.''} while prior literature has identified household factors---namely size, and age of parents---that push Mormon applicants to become early, unqualified entrants to the mortgage market, and therefore more susceptible to application rejections and subprime lending.\footnote{Lown, ``Educating and Empowering Consumers to Avoid Bankruptcy.''}
...
\epigraph{No man who owns his own house and lot can be a Communist. He has too much to do.}{William Levitt}
...
See Figure \ref{fig:geography} for the Census Bureau's graphical representation.\footnote{Lemery, ``LibGuides.''}
\begin{figure}
...
I began by downloading precinct-level voting returns from the Harvard Election Data Archive (HEDA).\footnote{Ansolabehere, Palmer, and Lee, ``Precinct-Level Election Data, 2002-2012.''}
...
A similar process of decomposition followed by recomposition was used for the Department of Housing and Urban Development's foreclosure data,\footnote{Bucholtz, ``Neighborhood Level Foreclosure Data''; Cody, ``Neighborhood Stabilization Program Data''; Richardson, ``NSP2 Data and Methodology.''} which was tabulated at the 2000 tract- and block group--level.
...
Lastly, data from the 2010 US Religion Census\footnote{Grammich et al., ``U.S. Religion Census Religious Congregations and Membership Study, 2010 (County File).''} and the Bureau of Labor Statistics\footnote{``LAUCN.''} is collected at the county-level.
...
\begin{table}[!htbp] \centering 
  ...
  \label{tab:prices} 
\begin{tabular}{@{\extracolsep{3pt}}lD{.}{.}{-4} D{.}{.}{-4} D{.}{.}{-4} } 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
R$^{2}$ & \multicolumn{1}{c}{0.8319} & \multicolumn{1}{c}{0.7851} & \multicolumn{1}{c}{0.8320} \\ 
Adjusted R$^{2}$ & \multicolumn{1}{c}{0.8316} & \multicolumn{1}{c}{0.7848} & \multicolumn{1}{c}{0.8310} \\ 
Residual Std. Error & \multicolumn{1}{c}{7.3044} & \multicolumn{1}{c}{8.2569} & \multicolumn{1}{c}{7.7767} \\ 
F Statistic & \multicolumn{1}{c}{2,819.9000$^{***}$} & \multicolumn{1}{c}{2,429.8210$^{***}$} & \multicolumn{1}{c}{863.3943$^{***}$} \\ 
\hline 
\hline \\[-1.8ex] 
...
The estimated negative impacts agree with results from a HUD evaluation of the Neighborhood Stabilization Program's second round of funding, which found insignificant-to-negative changes in home prices.\footnote{Spader et al., ``The Evaluation of the Neighborhood Stabilization Program.''}
...
R$^{2}$ & \multicolumn{1}{c}{0.4338} & \multicolumn{1}{c}{0.4485} \\ 
Adjusted R$^{2}$ & \multicolumn{1}{c}{0.4334} & \multicolumn{1}{c}{0.4480} \\ 
Residual Std. Error & \multicolumn{1}{c}{15.1571} & \multicolumn{1}{c}{14.9599} \\ 
F Statistic & \multicolumn{1}{c}{987.9295$^{***}$} & \multicolumn{1}{c}{880.7758$^{***}$} \\ 
\hline 
\hline \\[-1.8ex] 
...
I account for this with post-crisis literature which argues that individuals with risky occupations face additional barriers to securing home equity lines of credit (HELOCs).\footnote{Mota, ``Spatial Features of Labor Markets and Links to the Housing Market,'' Table 1.}
...
R$^{2}$ & \multicolumn{1}{c}{0.5507} & \multicolumn{1}{c}{0.5612} \\ 
Adjusted R$^{2}$ & \multicolumn{1}{c}{0.5496} & \multicolumn{1}{c}{0.5599} \\ 
Residual Std. Error & \multicolumn{1}{c}{11.2272} & \multicolumn{1}{c}{11.0983} \\ 
F Statistic & \multicolumn{1}{c}{506.5095$^{***}$} & \multicolumn{1}{c}{443.6774$^{***}$} \\ 
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{2}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
\end{tabular} 
...
I excluded the second and third NSP rounds because, as of July 2011, respectively 20.6\% and 0.4\% of funds had been expended from NSP2 and NSP3.\footnote{18568, ``HUD NSP3 Report''; 18568, ``HUD NSP2 Report.''}
Thus, any perceived effects could not been due to the price effects sought by the program.
Though NSP1 had expended 43.4\% of funds and fully committed its allocations to grantees by September 2010,\footnote{18568, ``HUD NSP-1 Reporting Sept 2010.''} the analysis of housing prices above demonstrates that the program had not yet (if it had eventually) raised prices for recipients.
...
\hline \\[-1.8ex] 
 ...
 \hline \\[-1.8ex] 
State fixed Effects? & Y & Y \\ 
Observations & \multicolumn{1}{c}{27,098} & \multicolumn{1}{c}{8,700} \\ 
R$^{2}$ & \multicolumn{1}{c}{0.3117} & \multicolumn{1}{c}{0.5748} \\ 
Log Likelihood & \multicolumn{1}{c}{10,222.2100} & \multicolumn{1}{c}{6,853.0630} \\ 
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{2}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
\end{tabular} 
...
Further, by NSP1's maturation in 2013, the amount of funds spent on acquisitions dropped, while new construction and rehabilitation increased slightly compared to its 2010 progress.\footnote{18568, ``Sept 2010 Program-Wide Report''; HUD, ``HUD NSP1 Report.''}
...
In the face of stagnating wages, outsourced manufacturing, and uncertain career mobility, homeowners became asset managers, supplementing their incomes with home equity lines of credit and reverse mortgages,\footnote{Lasky and Gisselquist, ``Housing Wealth and Consumer Spending.''} or placing their retirement dreams in a national housing market that had climbed every month of every year from May, 1991 to March, 2006.\footnote{``CSUSHPISA.''}
...
These policies increased demand for homeownership and fixed people in their suburban communities.\footnote{Jackson, \emph{Crabgrass Frontier}.}
...
At the same time, he focused on curbing welfare spending, revitalizing Richard Nixon's successful Southern Strategy with allusions to historical Republican rhetoric,\footnote{DuVernay, ``13th.''} while simultaneously with increasing military expenditure.
...
When equity was low, and mortgage (or second mortgage) debt was still present, a bump in prices could give the necessary loft to pay off credit card bills\footnote{Buchholz and Larrimore, ``Federal Reserve Surveys.''} or necessary expenses.
...
Empirical work has focused on the existence of preferences rather than their priority,\footnote{Ansell, ``The Political Economy of Ownership,'' May 2014.} as data on individual home wealth and bespoke polling are expensive.
...
This movement has seen 2012 presidential hopeful Mitt Romney, formerly of Bain Capital, speak out against private equity.\footnote{Romney, ``Sen. Romney Cap Gains Letter to Treasury.''}
It has seen 2016 hopeful Marco Rubio lay out a vision of economic re-nationalization,\footnote{Rubio, ``American Industrial Policy and the Rise of China.''} which seems more and more possible as the coronavirus exposes autarkic deficiencies in American supply chains and the Small Business Association (helmed by Rubio) rolls out emergency assistance to American businesses, with multinationals like cruise lines unable to cash in on the support.
And it has seen Missouri senator Josh Hawley emerge possibly as the trends most ideologically-articulate speaker, with proposals for more forceful antitrust and more explicitly reactionary rhetoric.\footnote{Hawley, ``Getting America Back to Work.''}
...
R$^{2}$ & \multicolumn{1}{c}{0.4338} & \multicolumn{1}{c}{0.4339} & \multicolumn{1}{c}{0.4359} \\ 
Adjusted R$^{2}$ & \multicolumn{1}{c}{0.4334} & \multicolumn{1}{c}{0.4335} & \multicolumn{1}{c}{0.4354} \\ 
Residual Std. Error & \multicolumn{1}{c}{15.1571} & \multicolumn{1}{c}{15.1560} & \multicolumn{1}{c}{15.1298} \\ 
F Statistic & \multicolumn{1}{c}{987.9295$^{***}$} & \multicolumn{1}{c}{988.2385$^{***}$} & \multicolumn{1}{c}{996.1356$^{***}$} \\ 
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{3}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
\end{tabular} 
