...
Fears of a debt spiral triggered by falling home prices also beset cities,[@dennis2011falling; @muro1fiscal; @saulny2008financial] though there is some doubt that those fears were justified.[@gross2012local; @lutz2011housing]
...
This swarm presaged the unanimous passage of the Minnesota Moratorium Act, a key piece of state mortgage legislation whose constitutionality would be upheld in @1934home, paving the way for further states to enact statutory protections for mortgagors during the Great Depression.
...
Anyone who has heard those around them grumble about high property taxes may wonder why they are not mentioned in this section.
After all, nearly one of every three municipal dollars springs from taxes assessed on real estate.[@gross2012local, 1]
Yet anyone who has paid property taxes likely knows the reason for its exclusion here: home values are not assessed every year.
In 2007, 2008, and 2009, this feature likely acted as the lower arm of a pair of price scissors---though they were *very* rusty, unable to close completely since property taxes rarely top 2%---holding stable as housing prices plummeted.
For cities, however, the lag meant that, depending on their specific schedules, cities were initially cushioned from the housing bust, and may have actually seen increases in revenue.[@chernick2017effect, Fig. 5]
There is little research on this effect, but more recent scholarship points to large decreases beginning in 2009 or 2010 and extending as late as 2013.[@chernick2017effect; @gross2012local]
The size of this lag may account of the lack of consensus on the topic, with research by the Federal Reseve Board of Governors denying significant fiscal effects of foreclosures.[@lutz2011housing]
At any rate, while property taxes did strain municipal budgets, cities did not feel the effects until after the foreclosure crisis elicited policy responses.

Rather, features of the U.S. Constitution were interpreted by the Supreme Court to justify federal action, which is partially responsible for the shift in spending from states and municipalities to the federal government as seen in \@(fig:spending-shift).
...
In the Great Depression, the meaning of the Contract Clause was challenged, as mentioned, in @1934home.
...
The interpreted mandate to protect government interests coordinated with a pragmatist turn in Constitutional jurisprudence to authorize the federal goverment to enter state policy jurisdictions.[@horwitzTransformationAmericanLaw1992]

New Deal policies wielded the Commerce Clause to implement its policies.

For defendants, the burden of evidence fell on the extension of business effects to other states.
...
State investment had now been supplanted; this opened an opportunity for balanced-budget interest groups to organize around pruning back property taxes.[martin]

Taxpaying voters were then adjusted to low tax receipts, leaving support for higher taxes thin.

This movement starved states and cities of the resources necessary to handle foreclosure.[@stein2019capital]
...
Legal incorporation has historically been treated by U.S. courts as a way to separate ontologically the individual assets from their controlling parties.[dewey]

The practical particularities of REMICs sever any remaining lines of communication by which investors could express their interests.

By removing the principal from the process, MBS securitization granted the agent free[r] reign.

Foreclosures were in the interests of the mortgage-servicing agents to mortgage-backed securities.

Thus, investors' hands were tied.

<!--This possibly should be chapter 2-->
