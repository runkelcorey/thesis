...
Features of the U.S. Constitution were interpreted by the Supreme Court to justify federal action, which is partially responsible for the shift in spending from states and municipalities to the federal government as seen in \@ref(fig:spending-shift).
...
Securitization is a complicated process, pictured in \@ref(fig:immergluck) legally incorporating the collection of mortgages that back a residential mortgage-backed securities (MBS).
...
```{r immergluck, fig.align='center', fig.cap="Taken from Immergluck, 2011", echo=FALSE, out.width="90%"}
