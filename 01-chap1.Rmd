...
``` {r caseshiller, fig.cap = "Price (right axis) and growth (left axis) of the Case-Shiller Home Price Index, adjusted for seasonal price fluctuations.", echo = FALSE, out.width='90%'}
...
```{r wheelock-farms, fig.cap="Figure taken from @wheelockChangingRulesState2008", echo=FALSE, out.width='90%'}
...
```{r tradingecon, fig.cap = "Existing versus New Home Sales, 2000-2014", echo=FALSE, out.width='90%'}
...
This swarm presaged the unanimous passage of the Minnesota Moratorium Act, a key piece of state mortgage legislation whose constitutionality would be upheld in *Blaisdell v. Home Building & Loan Association*, paving the way for further states to enact statutory protections for mortgagors during the Great Depression.
...
Following the neoclassical literature, this separation led to perverse incentives: while investors lost money from foreclosures, the trustees of mortgage-backed securities gained money from foreclosures.
