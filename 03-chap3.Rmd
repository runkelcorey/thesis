...
$rep_i = \beta_0 + \beta_1forq_i + \beta_2Black_i  + \beta_3AmerIndian_i + \beta_4urbanicity_i + \beta_5evang_i + \beta_6lds_i + \beta_7Hispanic_i + \beta_8medHHI_i + \beta_9chgHHI_i + \beta_{10}ownhome_i + \beta_{11}unem10_i + \beta_{12}old_i + \beta_{13}(somecol_i \times white_i) + \epsilon_i$