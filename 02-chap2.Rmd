...
```{r distress, fig.cap= "Left: Total foreclosures and short sales by owner type. Right: Probability of home loss by owner type.", echo = FALSE, out.width='45%', fig.align='center'}
...
```{r hhdebt, echo=FALSE, out.width='90%', fig.align='center', fig.cap="Outstanding US residential mortgage debt as a percentage of US gross domestic product."}
...
```{r minsky, fig.align='center', out.width='90%', fig.cap="Minsky cycle, theorized by Hyman Minsky.", echo=FALSE}
...
```{r acceptance, fig.align='center', out.width='45%', fig.cap="Number of tax mentions by party in presidential nomination acceptance speeches (left); percentage of general election TV ads to feature taxation (right).", echo=FALSE}
...
```{r, publicdebt, fig.align='center', out.width='90%', fig.cap="Federal public debt as a percentage of gross domestic product.", echo=FALSE}
...
```{r deficit, fig.align='center', out.width='90%', fig.cap="Percentage of respondents who say that reducing the budget deifict is a top priority by party affiliation.", echo=FALSE}
