...
While higher levels of wealth and income are colloquially associated with conservatism, but there is less research on how asset ownership pushes people towards their political decisions.<!--(BRING IN EMBOURGEOISIEMENT HERE?)-->
...
```{r publicdebt, fig.align='center', out.width='30%', fig.cap="Federal public debt as a percentage of gross domestic product.", echo=FALSE, dev='pdf'}
...
```{r deficit, fig.align='center', out.width='90%', fig.cap="Percentage of respondents who say that reducing the budget deifict is a top priority by party affiliation.", echo=FALSE, dev='pdf'}
