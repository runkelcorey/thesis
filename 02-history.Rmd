...
The necessity of these measures is questionable: while 45% of Sand State mortgages issued in 2006 were for second, third, or fourth properties,[@mian2011house, 2150] it is important to remember that the majority of those foreclosed upon were prime borrowers.[@ferreira2015new]
...
```{r distress, fig.cap="Measures of homeowner distress timing, taken from Ferreira & Gyourko (2015).", fig.subcap=c("Total foreclosures and short sales by owner type","Probability of home loss by owner type."), echo = FALSE, out.width='45%', fig.align='center', dev='pdf', fig.ncol=2}
...
```{r minsky, fig.align='center', out.width='90%', fig.cap="A cycle of speculative finance theorized by Hyman Minsky.", echo=FALSE, dev='pdf'}
...
There are therefore ambiguous political forces at work in a recipient's conception of the NSP: on the one hand, it may be emblematic of the larger welfare state bankrupting the economy on unnecessary programs, triggering a backlash by voters; on the other hand, by raising prices, it may have increased the home equity of voters, pushing their view further right.
