...
These two lines converge with the Neighborhood Stabilization Program (NSP) amid the rise of the Tea Party.
...
Mortgages originated in 2006 and 2007 suffered 45% default rates,[@schwartz2009politics, 200] much of them clustering in the Sand States of California, Nevada, Arizona, and Florida.
Countrywide Financial, which two years earlier had serviced 20% of United States mortgages,[@schwartz2009politics] collapsed in July 2008 (and subsequently resurrected under Bank of America).
...
```{r wheelock-farms, fig.cap="Figure taken from Wheelock (2008).", echo=FALSE, out.width='90%', fig.align='center', dev='pdf'}
...
```{r spending-shift, fig.cap = "While secular growth is present at all levels of government, note the spikes during the Great Depression and Recession, and of course in wars.", fig.align='center', out.width='90%', echo=FALSE, dev='pdf'}
...
```{r immergluck, fig.align='center', fig.cap="Taken from Immergluck (2011).", echo=FALSE, out.width="90%", dev='pdf'}
